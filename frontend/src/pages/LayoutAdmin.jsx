                ...
                <div className='grid grid-cols-12 gap-4 md:gap-6'>
                    <div className='col-span-12 space-y-6 xl:col-span-7'>
                        ...
                        dark:bg-white/[0.03] md:p-6'>
                                <div
                                    className='flex items-center justify-center w-12 h-12 bg-gray-100
                                rounded-xl dark:bg-gray-200'>
                                    <Users size={20}></Users>
                                </div>
                                <div className='flex items-end justify-between mt-5'>
                                    ...
                                    <span className='inline-flex items-center px-2.5 py-0.5 justify-center
                                gap-1 rounded-full font-medium text-sm bg-green-50 text-green-600
                                dark:bg-green-500/15 dark:text-green-500'>
                                        <MoveUp size={14}></MoveUp>
                                        11.01%
                                    </span>
                                </div>
                            </div>
