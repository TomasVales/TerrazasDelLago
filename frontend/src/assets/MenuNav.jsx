...
const MenuNav = ({ cartItems, setCartItems, setMostrarTransferencia }) => {
    ...
    return (
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
            ...
            {/* Barra de búsqueda */}
            <div className='bg-gray-200 rounded-full flex items-center px-2 sm:w-[400px] lg:w-[600px]'>
            ...
            {/* Botón carrito */}
            <button
                className='bg-[#208850] rounded-full text-white hidden md:flex items-center pr-4 pl-4 py-2 hover:scale-105 duration-300 cursor-pointer'
          ...
          bg-white z-10 duration-300 overflow-y-auto custom-scroll'>
                        <div className='flex justify-between items-center p-4 border-b border-gray-600 '>
                            <h2 className='text-2xl text-[#208850] font-bold'>Carrito</h2>
                            <button
                        ...
                        <div className='flex gap-6'>
                            <button
                                ...
                                className='py-2 px-5 cursor-pointer rounded-[10px] text-[#208850] bg-white hover:bg-[#208850] hover:text-white border '
                            >
                                Completar Orden
                            </button>
                            <button
            ...
            <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
                ...
                <h2 className='text-2xl p-4'><span className='text-[#208850] font-bold'>Terrazas Del Lago</span></h2>
                <nav>
                    <ul className='flex flex-col p-4 text-gray-800'>
                        <li
                            className='text-xl py-4 flex gap-1 cursor-pointer hover:text-[#208850] transition-all'
                            onClick={() => {
                        ...
                        <li className='text-xl py-4 flex gap-1 cursor-pointer hover:text-[#208850] transition-all'>
                            <a
