                                ...
                                <table className='w-full caption-bottom text-sm'>
                                    <thead className='border-b'>
                                        <tr className='border-b border-gray-200 transition-colors hover:bg-gray-50 bg-white'>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500 w-[100px] sm:table-cell'>
                                                <span className='sr-only'>imagen</span>
                                            </th>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500'>Nombre</th>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500'>Stock</th>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500 hidden md:table-cell'>Precio</th>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500 hidden md:table-cell'>Ventas Totales</th>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500 hidden md:table-cell'>Creación</th>
                                            <th className='h-15 px-4 text-left align-middle font-medium text-gray-500'>
                                        ...
                                        {filteredProducts.map((product, index) => (
                                            <tr key={product.id} className='border-b border-gray-100 hover:bg-gray-50 bg-white'>
                                                ...
                                                <td className='p-4 align-middle relative'>
                                                    ...
                                                    {showMenu === index && (
                                                        <div className='absolute p-1 right-19 bottom-10 transition duration-300 w-32 bg-white border border-gray-200 rounded-md shadow-lg z-9999'>
